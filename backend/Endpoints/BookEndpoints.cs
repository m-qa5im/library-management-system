...
namespace backend.Endpoints
{
    public static class BookEndpoints
    {
        public static void MapBookEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            // GET /books - Fetch every book entry inside the database catalog (Admin View)
            ...
            // DELETE /books/{id} - Remove or soft-delete a literary asset from the inventory database
            ...
            // PUT /books/{id} - Modify existing book specifications
